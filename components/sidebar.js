        ...
        <div className="flex flex-col gap-2 md:gap-8 md:pl-20 py-4">
            <div className="flex flex-row gap-3">
                ...
                <div className="flex flex-col">
                    <span className="font-black text-lg">Joel</span>
                    <span className="text-sm">@+250786082841</span>
                </div>
            </div>
            <div className="flex flex-row gap-3">
                ...
                <Link href="/home" className="text-blue-600 font-bold">Ahabanza</Link>
            </div>
            <div className="flex flex-row gap-3">
                ...
                <Link href="/courses" className="font-bold">Amasomo mfata</Link>
            </div>
            <div className="flex flex-row gap-3">
            ...
            <div className="flex flex-row gap-3">
                ...
                <Link href="/ikofi" className="font-bold">Ikofi</Link>
            </div>
