    ...
    return (
        <div className="flex flex-col gap-2 md:gap-8 md:pl-20 py-4">
            ...
            <div className="flex flex-row gap-3">
                ...
                <span className="text-blue-600 font-bold">Ahabanza</span>
            </div>
            <div className="flex flex-row gap-3">
                ...
                <span className="font-bold">Amasomo mfata</span>
            </div>
            <div className="flex flex-row gap-3">
