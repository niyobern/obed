...
export default function Card(){
    return (
        <div className="border border-gray-300 flex flex-col">
            ...
            <span className="text-center py-12 text-blue-900 text-sm font-medium px-2">Imiterere y' ibyapa bibuza cyangwa bitegeka</span>
            <div className="flex gap-4 items-center p-2">
                <FaPlay color="green" className="w-3 h-3"/>
                <span className="text-sm font-medium text-gray-800">Bimeze nk' ingasire izengurutswe n' ibara ritukura kandi ubuso bukera</span>
            </div>
