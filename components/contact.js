...
import image from "../public/images/unspash.jpg";
    ...
    return (
            <div className="flex w-full flex-col h-fit md:grid grid-rows-6 grid-cols-2">
                <div className="row-start-1 col-span-full row-end-4 w-full pb-8 relative flex flex-col">
                    ...
                    <p className="md:w-1/2 self-center z-10 text-center text-white bg-gray-900 bg-opacity-50" id="contact2">Text 2</p>
                </div>
                ...
                <div className="row-start-3 col-span-full row-span-4 md:p-2 bg-gray-100 md:mx-24 z-20 flex flex-col md:grid grid-cols-5 grid-rows-2 gap-y-4 gap-x-8">
                    <div className="grid grid-cols-5 grid-rows-3 bg-white shadow col-start-1 col-span-2 row-start-1 py-10 gap-x-4 md:pl-12">
                        ...
                        <span className="col-start-2 col-span-4 row-span-1 self-center text-gray-600" id="contact3">Text 3</span>
                        <span className="col-start-2 col-span-4 row-span-1 self-center text-sky-600 text-xl font-bold leading-none" id="contact4">Text 4</span>
                        <div className="col-start-2 col-span-4 row-span-1 self-center text-sky-600 text-sm hover:bg-sky-600 hover:text-white active:bg-red-500 active:text-white w-fit py-2 hover:px-2 cursor-pointer rounded" id="contact5">Text 5</div>
                    </div>
                    <div className="grid grid-cols-5 grid-rows-3 bg-white shadow col-start-1 col-span-2 row-start-2 py-10 md:pl-8">
                        ...
                        <span className="col-start-2 col-span-4 row-span-1 self-center text-gray-600 pl-2" id="contact7">Text 6</span>
                        <div className="col-start-2 col-span-4 row-span-2 self-center text-white bg-sky-600 cursor-pointer hover:bg-green-600 active:bg-red-500 py-2 px-6 justify-self-start" id="contact6">Text 7</div>
                    </div>
                    <div className="flex flex-col col-start-3 col-span-3 row-span-2 bg-white shadow-xl pt-8">
                        <h1 className="text-xl font-bold self-center text-gray-800" id="contact8">Text 8</h1>
                        <div className="text-sm sefl center text-center py-2" id="contact9">Text 9</div>
                        <div className="flex flex-col md:grid grid-cols-2 p-2 md:px-10 gap-2">
                            <div className="flex flex-col py-2">
                                <label htmlFor="firstName" className="pb-1 text-sm uppercase text-gray-700" id="contact13">Text 10</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="lastName" className="pb-1 text-sm uppercase text-gray-700" id="contact10">Text 11</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="email" className="pb-1 text-sm uppercase text-gray-700" id="contact11">Text 12</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="phone" className="pb-1 text-sm uppercase text-gray-700" id="contact12">Text 13</label>
                            ...
                            <div className="flex flex-col py-2">
                                <label htmlFor="message" className="pb-1 text-sm uppercase text-gray-700" id="contact14">Text 14</label>
