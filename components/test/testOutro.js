...
export default function TestOutro({ id, length, lastDay, lastTime, score }){
    return (
            ...
            <div className="flex flex-col">
                <div className="flex flex-col px-2 gap-2">
                    ...
                    <div className="bg-blue-700 w-full px-2 lg:px-4 py-2 lg:py-3 text-white flex justify-between items-center rounded">
                        <span className="text-sm font-medium">Amanota: {score}/{length}</span>
                        <Link href={`/tests/${id}`} className="cursor-pointer px-1 border-2 border-white rounded hover:bg-white hover:text-green-800">Subiramo</Link>
