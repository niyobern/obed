...
export default function TestGrid( { number, choose } ){
  const router = useRouter()
    return (
            <div onClick={() => choose(number)} className="cursor-pointer hover:bg-gray-200 grid grid-cols-7 w-full gap-2 border border-gray-300">
