...
export default function TestGrid( { number } ){
    return (
            <div className="grid grid-cols-7 w-full gap-2 border border-gray-300">
                ...
                <div className="flex flex-col p-2 col-span-4 gap-2">
                  <p className="font-medium text-xs leading-none">Isuzuma #K{number}: riteguye nk&aposikizamini cy&aposuruhushya rw&aposagateganyo rwa Polisi.</p>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="uppercase text-xs">Isuzuma</span>
                  </div>
                </div>
            </div>
    )
