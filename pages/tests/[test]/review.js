...
export default function ReviewTest({ questions, slug }){
    ...
    useEffect(() => {
        ...
        if (!rawResults || rawScore === null){
            ...
            setAnswers(JSON.parse(rawResults))
